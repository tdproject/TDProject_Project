...
/**
 * TDProject_Project_Block_Widget_Button_Export
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Project_Block_Widget_Button_Export
    ...
    public function __construct(
		...
		$this->setOnClick(
			'window.open("' . $form->getExportUrl() . '"); return false;'
		);
    }
}