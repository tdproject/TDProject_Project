...
/**
 * TDProject_Project_Block_Template_View_Tasks_Task
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Project_Block_Template_View_Tasks_Task
    ...
    public function __construct(
        ...
        $this->_setTemplate(
        	'www/design/project/templates/template/view/tasks/task.phtml'
        );
