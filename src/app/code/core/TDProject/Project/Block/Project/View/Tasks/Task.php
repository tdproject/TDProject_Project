...
/**
 * TDProject_Project_Block_Project_View_Tasks_Task
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Project_Block_Project_View_Tasks_Task
    ...
    public function __construct(
        ...
        $this->_setTemplate(
        	'www/design/project/templates/project/view/tasks/task.phtml'
        );
