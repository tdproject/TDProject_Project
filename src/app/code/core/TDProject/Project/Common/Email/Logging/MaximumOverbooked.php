...
/**
 * TDProject_Project_Common_Email_Logging_MaximumOverbooked
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class TDProject_Project_Common_Email_Logging_MaximumOverbooked
	...
	/**
	 * The maximum estimation time for the task.
	 * @var integer
	 */
    ...
    public function __construct()
    {
        ...
        $this->setTemplateHtml(
        	'www/design/project/templates/email/logging/maximum_overbooked.phtml'
        );
        $this->setTemplateText(
        	'www/design/project/templates/email/logging/maximum_overbooked.txt.phtml'
        );
    }
    ...
    {
    	return '[' . self::APPLICATION_NAME . '] - Task Maximum überbucht';
    }
